...
class SaleReportByShopExport implements FromView
{
    // public function view(): View
    // {
    //     return view('exports.sale-report-by-shop', [
    ...
    public function view(): View
    {
        ...
        return view('exports.sale-report-by-shop', ['start_date' => $this->start_date, 'end_date' => $this->end_date, 'applications' => $applications, 'selected_shop' => $this->shop_id, 'status' => $this->status]);
    }
}
