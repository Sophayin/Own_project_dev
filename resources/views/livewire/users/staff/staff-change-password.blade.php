                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('current_password') is-invalid @enderror" placeholder="{{ __('Current Password')}}" wire:model="current_password">
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('password') is-invalid @enderror" placeholder="{{__('Password')}}" wire:model="password">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="{{__('Re-type Password')}}" wire:model="password_confirmation">
