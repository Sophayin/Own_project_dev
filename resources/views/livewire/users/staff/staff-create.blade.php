                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-3">
                                ...
                                <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="{{ __('Re-type Password')}}" wire:model="password_confirmation">
                            ...
                            <div class="col">
                                ...
                                <select wire:model="role_id" class=" form-select form-select-lg @error('role_id') is-invalid @enderror">
