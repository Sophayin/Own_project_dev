            ...
            <div class="d-flex mb-3">
                ...
                <div class="p-2">
                    <div class="card-body">
                        <div class="p-2">
                            <div class="col-lg-12 col-sm-6">
                                <h6>{{__('Remain Expense')}}</h6>
                                <h4 class="text-center">$ {{number_format(abs($total_current_expense - $amount),2)}}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body border-0 shadow-sm">
                        ...
                        <div class="row d-flex p-1">
                            ...
                            <div class="col-lg-5 p-2" style="margin-top: -17px;">
                                ...
                                <h6 class="mt-3"> <strong>$ {{number_format($daily->coffee_price,2)}}</strong></h6>
                                <h6 class="mt-3"> <strong>$ {{number_format($daily->party,2)}}</strong></h6>
                                <h6 class="mt-3"> <strong>$ {{number_format($daily->gasoline_price,2)}}</strong></h6>
                            </div>
                            <div class="col-lg-12">
