            ...
            <div class=" p-3 row d-flex">
                <div class="col-lg-12 d-flex text-center justify-content-center">
                    <div class="row text-center d-flex justify-content-center">
                        <div class="col-lg-4 col-md-4 col-sm-12 w-75 justify-content-center">
                            <div class="col-12 d-flex justify-content-center mt-5">
                                <img src="{{asset('assets/auth/image.png')}}" alt="" width="140px" height="140px"
                                    style="border: 1px solid Lightgray; border-radius: 50%;">
                            </div>
                            <div class="col-12 d-flex justify-content-center mt-4">
                                <h3 class="mt-3">Login To Expense</h3>
                            </div>
                            <div class="row mb-5">
                                ...
                                <form class="row g-3 needs-validation" wire:submit.prevent="doLogin">
                                    ...
                                    <div class="col-12 mb-5">
                                        <button class="btn btn-primary w-100" type="submit"
                                            style="border: none; border-radius: 50px; background: #034C72;">Login</button>
                                    </div>
                                </form>
                            </div>
                        </div>
