        ...
        <div class="container-fluid" id="printable-div">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 text-center">
                    ...
                    <h5 class="text-primary Daily_report">{{ __('Sale Report By 121 Shop | Location') }}</h5>
                ...
                <div class="d-flex p-2">
                    ...
                    <div class="col-lg-2 d-none d-sm-block p-2">
                        <select wire:model.live="selected_shop" class="form-control form-select border-0 bg-light" style="height: 40px;">
                            <option value="" class="all_shop">{{__('All Shop')}}
                            </option>
                    ...
                    <div class="col-lg-2 d-none d-sm-block p-2" style="width: 12%;">
                        <select wire:change="onFilterStatus($event.target.value)" class="form-control form-select border-0 bg-light" style="height: 40px;">
                    ...
                    <table class="table table-sm ">
                        ...
                        <tbody>
                            ...
                            <tr class="text text-center">
                                ...
                                <td class="text-secondary text-sm">{{$item->client_name}}</td>
