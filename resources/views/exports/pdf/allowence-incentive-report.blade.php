        ...
        <table class="table" style="border:none;">
            <thead>
                ...
                <tr class="text-center">
                    ...
                    <th rowspan="2" class="text-center text-secondary text-sm font-weight-bolder opacity-7"> {{__('Sale by Team')}}</th>
                    ...
                    <th rowspan="2" class="text-center text-secondary text-sm font-weight-bolder opacity-7"> {{__('Bank Account')}}</th>
                    <th rowspan="2" class="text-center text-secondary text-sm font-weight-bolder opacity-7"> {{__('Bank Account')}}</th>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="text-secondary text-sm">{{$agenIncentive->agency->position->name ?? ''}}</td>
                    <td class="text-secondary text-sm">{{$agenIncentive->own_sale}}</td>
                    <td class="text-secondary text-sm">{{$agenIncentive->sale_by_team}}</td>
                    <td class="text-secondary text-sm">{{$agenIncentive->sale_by_indirect_team}}</td>
