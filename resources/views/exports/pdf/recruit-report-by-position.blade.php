        ...
        <table class="table" style="border:none;">
            <thead>
                <tr style="border:none;">
                    ...
                    <th colspan="7" style="border:none; font-size: 15px;padding-bottom: 15px">
                        ...
                        <h3 style="color: blue;">{{ __('Recruit Report By Agency Position') }}</h3>
                ...
                <tr>
                    ...
                    <th> {{__('Agency Name (latin)')}}</th>
                    <th> {{__('Gender')}}</th>
                    <th> {{__('Register Date')}}</th>
                    <th> {{__('Working Day')}}</th>
                    <th> {{__('Summary')}}</th>
                    <th> {{__('Address')}}</th>
                    <th> {{__('Khmer Identity Card')}}</th>
                    <th> {{__('Leader')}}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{ Today()->diffInDays(Carbon\Carbon::parse($agency->created_at)) }} days
                    </td>
                    <td>{{$agency->remark}}</td>
                    <td>
                        {{$agency->address ? ($agency->address->city? $agency->address->city->name: ""): ""}}
                    </td>
                    <td>{{$agency->khmer_identity_card}}</td>
                    <td>{{$agency->parent? $agency->parent->code: ""}}</td>
                    <td>
